...
<body>
  ...
  <div class="container">  
    <div class="table-responsive" ng-app="liveApp" ng-controller="liveController" ng-init="fetchData()">
      ...
      <table class="table table-bordered table-striped">
        ...
        <tr>
            ...
            <th scope="col">Total number of songs  </th>
            <th scope="col"> </th>
    ...
    <tr>
          <td> </td>
          <td><input type="text" ng-model="addData.playlist_title" class="form-control" placeholder="Enter the playlist title" ng-required="true" /></td>
          <td><input type="int" ng-model="addData.playlist_likes" class="form-control" placeholder="Enter the playlist likes" ng-required="true" /></td>
          <td><input type="float" ng-model="addData.total_duration" class="form-control" placeholder="Enter the total duration" ng-required="true" /></td>
          <td><input type="int" ng-model="addData.n_of_songs" class="form-control" placeholder="Enter the number of songs" ng-required="true" /></td>          
      ...
      <script type="text/ng-template" id="display">
                    <td>{{data.playlist_id}}</td>
                    <td>{{data.playlist_title}}</td>
                    <td>{{data.playlist_likes}}</td>
                    <td>{{data.total_duration}}</td>
                    <td>{{data.n_of_songs}}</td>


                    <td>
                        <button type="button" class="btn btn-primary btn-sm" ng-click="showEdit(data)">Edit</button>
                        <button type="button" class="btn btn-danger btn-sm" ng-click="deleteData(data.playlist_id)">Delete</button>
                    </td>
                </script>
                <script type="text/ng-template" id="edit">
                  <td>{{data.playlist_id}}<input type="hidden" ng-model="formData.playlist_id" class="form-control" /></td>
                    <td><input type="text" ng-model="formData.playlist_title" class="form-control"  /></td>
                    <td><input type="int" ng-model="formData.playlist_likes" class="form-control" /></td>
                    <td><input type="float" ng-model="formData.total_duration" class="form-control"  /></td>
                    <td><input type="int" ng-model="formData.n_of_songs" class="form-control" /></td>
                    <td>
                        <input type="hidden" ng-model="formData.data.playlist_id" />
...
app.controller('liveController', function($scope, $http){
    ...
    $scope.getTemplate = function(data){
        if (data.playlist_id === $scope.formData.playlist_id)
        {
            return 'edit';
        }
        else
    ...
    $scope.fetchData = function(){
        $http.get('select_playlist.php').success(function(data){
    ...
    $scope.deleteData = function(playlist_id){
