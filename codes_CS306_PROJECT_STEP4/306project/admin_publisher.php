...
<body>
  ...
  <div class="container">  
    ...
    <tr>
          <td> </td>
          <td><input type="text" ng-model="addData.pub_name" class="form-control" placeholder="Enter the publisher name" ng-required="true" /></td>
          <td><input type="date" ng-model="addData.pub_founded" class="form-control" placeholder="Enter the date" ng-required="true" /></td>
          <td><input type="int" ng-model="addData.pub_total_emp" class="form-control" placeholder="Enter the number of total employees" ng-required="true" /></td>
          <td><input type="int" ng-model="addData.pub_revenue" class="form-control" placeholder="Enter the revenue" ng-required="true" /></td>
      ...
      <script type="text/ng-template" id="display">
                    <td>{{data.pub_id}}</td>
                    <td>{{data.pub_name}}</td>
                    <td>{{data.pub_founded}}</td>
                    <td>{{data.pub_total_emp}}</td>
                    <td>{{data.pub_revenue}}</td>
                ...
                <script type="text/ng-template" id="edit">
                  <td>{{data.pub_id}}<input type="hidden" ng-model="formData.pub_id" class="form-control" /></td>
                    <td><input type="text" ng-model="formData.pub_name" class="form-control"  /></td>
                    <td><input type="date" ng-model="formData.pub_founded" class="form-control" /></td>
                    <td><input type="int" ng-model="formData.pub_total_emp" class="form-control"  /></td>
                    <td><input type="int" ng-model="formData.pub_revenue" class="form-control" /></td>

                    <td>
                        <input type="hidden" ng-model="formData.data.pub_id" />
...
app.controller('liveController', function($scope, $http){
    ...
    $scope.fetchData = function(){
        $http.get('select_publisher.php').success(function(data){
