...
<body>
  ...
  <div class="container">  
    ...
    <tr>
          <td> </td>
          <td><input type="text" ng-model="addData.music_name" class="form-control" placeholder="Enter the music name" ng-required="true" /></td>
          <td><input type="int" ng-model="addData.total_plays" class="form-control" placeholder="Enter the total plays" ng-required="true" /></td>
          <td><input type="float" ng-model="addData.music_rating" class="form-control" placeholder="Enter the music rating" ng-required="true" /></td>
          <td><input type="text" ng-model="addData.music_genre" class="form-control" placeholder="Enter the music genre" ng-required="true" /></td>
          <td><input type="date" ng-model="addData.music_date" class="form-control" placeholder="Enter the music date" ng-required="true" /></td>
      ...
      <script type="text/ng-template" id="display">
                    ...
                    <td>{{data.total_plays}}</td>
                    <td>{{data.music_rating}}</td>
                    <td>{{data.music_genre}}</td>
                    <td>{{data.music_date}}</td>


                    <td>
                        <button type="button" class="btn btn-primary btn-sm" ng-click="showEdit(data)">Edit</button>
                        <button type="button" class="btn btn-danger btn-sm" ng-click="deleteData(data.music_id)">Delete</button>
                    </td>
                </script>
                <script type="text/ng-template" id="edit">
                  <td>{{data.music_id}}<input type="hidden" ng-model="formData.music_id" class="form-control" /></td>
                    <td><input type="text" ng-model="formData.music_name" class="form-control"  /></td>
                    <td><input type="int" ng-model="formData.total_plays" class="form-control" /></td>
                    <td><input type="float" ng-model="formData.music_rating" class="form-control"  /></td>
                    <td><input type="text" ng-model="formData.music_genre" class="form-control" /></td>
                    <td><input type="date" ng-model="formData.music_date" class="form-control"  /></td>

                    <td>
                        <input type="hidden" ng-model="formData.data.music_id" />
...
app.controller('liveController', function($scope, $http){
    ...
    $scope.getTemplate = function(data){
        if (data.music_id === $scope.formData.music_id)
        {
            return 'edit';
        }
        else
    ...
    $scope.deleteData = function(music_id){
