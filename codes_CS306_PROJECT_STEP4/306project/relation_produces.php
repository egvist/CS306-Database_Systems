...
<body>
  ...
  <div class="container">  
    ...
    <tbody>
    <tr>
          <td><input type="text" ng-model="addData.music_id" class="form-control" placeholder="Enter the music ID" ng-required="true" /></td>
          <td><input type="text" ng-model="addData.producer_id" class="form-control" placeholder="Enter the producer ID" ng-required="true" /></td>
...
app.controller('liveController', function($scope, $http){
    ...
    $scope.fetchData = function(){
        $http.get('relation_produces_select.php').success(function(data){
    ...
    $scope.insertData = function(){
        $http({
            method:"POST",
            url:"relation_produces_insert.php",
            data:$scope.addData,
    ...
    $scope.editData = function(){
        $http({
            method:"POST",
            url:"relation_produces_edit.php",
            data:$scope.formData,
        }).success(function(data){
            $scope.success = true;
            $scope.successMessage = data.message;
    ...
    $scope.deleteData = function(music_id){
        if(confirm("Are you sure you want to remove it?"))
        {
            $http({
                method:"POST",
                url:"relation_produces_delete.php",
