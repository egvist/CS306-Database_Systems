...
<body>
  ...
  <div class="container">  
    ...
    <tr>
          ...
          <td><input type="text" ng-model="addData.platform_id" class="form-control" placeholder="Enter the platform ID" ng-required="true" /></td>
...
app.controller('liveController', function($scope, $http){
    ...
    $scope.fetchData = function(){
        $http.get('relation_liston_select.php').success(function(data){
    ...
    $scope.insertData = function(){
        $http({
            method:"POST",
            url:"relation_liston_insert.php",
            data:$scope.addData,
    ...
    $scope.deleteData = function(album_id){
        if(confirm("Are you sure you want to remove it?"))
        {
            $http({
                method:"POST",
                url:"relation_liston_delete.php",
