...
<body>
  ...
  <div class="container">  
    ...
    <tr>
          <td> </td>
          <td><input type="text" ng-model="addData.album_name" class="form-control" placeholder="Enter the album name" ng-required="true" /></td>
          <td><input type="int" ng-model="addData.mnth_listening" class="form-control" placeholder="Enter the monthly listeners" ng-required="true" /></td>
          <td><input type="float" ng-model="addData.album_rating" class="form-control" placeholder="Enter the album rating" ng-required="true" /></td>
          <td><input type="text" ng-model="addData.album_genre" class="form-control" placeholder="Enter the album genre" ng-required="true" /></td>
          <td><input type="date" ng-model="addData.album_date" class="form-control" placeholder="Enter the album date" ng-required="true" /></td>
          <td></td>
      ...
      <script type="text/ng-template" id="display">
                    ...
                    <td>{{data.mnth_listening}}</td>
                    <td>{{data.album_rating}}</td>
                    <td>{{data.album_genre}}</td>
                    <td>{{data.album_date}}</td>
                    <td></td>

                    <td>
                        <button type="button" class="btn btn-primary btn-sm" ng-click="showEdit(data)">Edit</button>
                        <button type="button" class="btn btn-danger btn-sm" ng-click="deleteData(data.album_id)">Delete</button>
                    </td>
                </script>
                <script type="text/ng-template" id="edit">
                  <td>{{data.music_id}}<input type="hidden" ng-model="formData.album_id" class="form-control" /></td>
                    <td><input type="text" ng-model="formData.album_name" class="form-control"  /></td>
                    <td><input type="int" ng-model="formData.mnth_listening" class="form-control" /></td>
                    <td><input type="float" ng-model="formData.album_rating" class="form-control"  /></td>
                    <td><input type="text" ng-model="formData.album_genre" class="form-control" /></td>
                    <td><input type="date" ng-model="formData.album_date" class="form-control"  /></td>

                    <td>
                        <input type="hidden" ng-model="formData.data.album_id" />
...
app.controller('liveController', function($scope, $http){
    ...
    $scope.getTemplate = function(data){
        if (data.album_id === $scope.formData.album_id)
        {
            return 'edit';
        }
        else
    ...
    $scope.fetchData = function(){
        $http.get('select_album.php').success(function(data){
    ...
    $scope.deleteData = function(album_id){
