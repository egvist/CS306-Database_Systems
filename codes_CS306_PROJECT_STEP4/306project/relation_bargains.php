...
app.controller('liveController', function($scope, $http){
    ...
    $scope.fetchData = function(){
        $http.get('relation_bargains_select.php').success(function(data){
    ...
    $scope.insertData = function(){
        $http({
            method:"POST",
            url:"relation_bargains_insert.php",
            data:$scope.addData,
    ...
    $scope.editData = function(){
        $http({
            method:"POST",
            url:"relation_bargains_edit.php",
            data:$scope.formData,
        }).success(function(data){
            $scope.success = true;
            $scope.successMessage = data.message;
    ...
    $scope.deleteData = function(pub_id){
        if(confirm("Are you sure you want to remove it?"))
        {
            $http({
                method:"POST",
                url:"relation_bargains_delete.php",
                data:{'pub_id':pub_id}
            }).success(function(data){
                $scope.success = true;
                $scope.successMessage = data.message;
