...
<body>
  ...
  <div class="container">  
    ...
    <tr>
          <td> </td>
          <td><input type="text" ng-model="addData.platform_name" class="form-control" placeholder="Enter the platform name" ng-required="true" /></td>
      ...
      <script type="text/ng-template" id="display">
                    ...
                    <td>
                        ...
                        <button type="button" class="btn btn-danger btn-sm" ng-click="deleteData(data.platform_id)">Delete</button>
                    </td>
                </script>
                <script type="text/ng-template" id="edit">
                  <td>{{data.platform_id}}<input type="hidden" ng-model="formData.platform_id" class="form-control" /></td>
                    <td><input type="text" ng-model="formData.platform_name" class="form-control"  /></td>

                    <td>
                        <input type="hidden" ng-model="formData.data.platform_id" />
...
app.controller('liveController', function($scope, $http){
    ...
    $scope.getTemplate = function(data){
        if (data.platform_id === $scope.formData.platform_id)
        {
            return 'edit';
        }
        else
    ...
    $scope.fetchData = function(){
        $http.get('select_platform.php').success(function(data){
    ...
    $scope.deleteData = function(platform_id){
        if(confirm("Are you sure you want to remove it?"))
        {
            $http({
                method:"POST",
                url:"delete_platform.php",
