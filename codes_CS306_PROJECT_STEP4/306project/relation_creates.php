...
<body>
  ...
  <div class="container">  
    ...
    <tr>
          ...
          <td><input type="text" ng-model="addData.a_id" class="form-control" placeholder="Enter the artist ID" ng-required="true" /></td>
...
app.controller('liveController', function($scope, $http){
    ...
    $scope.fetchData = function(){
        $http.get('relation_creates_select.php').success(function(data){
    ...
    $scope.insertData = function(){
        $http({
            method:"POST",
            url:"relation_creates_insert.php",
            data:$scope.addData,
    ...
    $scope.deleteData = function(music_id){
        if(confirm("Are you sure you want to remove it?"))
        {
            $http({
                method:"POST",
                url:"relation_creates_delete.php",
