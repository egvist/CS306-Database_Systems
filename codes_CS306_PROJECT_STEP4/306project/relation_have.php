...
<body>
  ...
  <div class="container">  
    ...
    <tr>
          ...
          <td><input type="text" ng-model="addData.playlist_id" class="form-control" placeholder="Enter the playlist ID" ng-required="true" /></td>
...
app.controller('liveController', function($scope, $http){
    ...
    $scope.fetchData = function(){
        $http.get('relation_have_select.php').success(function(data){
